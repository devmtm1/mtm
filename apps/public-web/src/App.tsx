...
const ClientChantiersPage = lazyPage(() =>
  import('./pages/client/ClientChantiersPage').then((m) => m.ClientChantiersPage),
);
      ...
      <BrowserRouter>
        <Routes>
          ...
          >
            ...
            <Route path="mon-chantier" element={<Deferred><ClientChantiersPage /></Deferred>} />
          </Route>
        </Routes>
      </BrowserRouter>
    </AuthProvider>
