...
export class TerrainForm implements OnInit {
  ...
  private cleanPayload(value: ReturnType<typeof this.form.getRawValue>): CreateTerrainPayload {
    ...
    const stringFields = ['parcelleMatricule', 'proprietaireId', 'typeDocumentFoncier', 'region', 'commune', 'localisationDetail', 'accesRoutier', 'voisinage', 'vocation', 'proximiteAxes', 'description', 'notesInternes', 'uniteSuperficie', 'justification'] as const;
